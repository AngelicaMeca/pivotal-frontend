...
import { DASHBOARD_URL, dashboardHref, dashboardSections } from "@/lib/dashboard";
...
// Direct access to the B³ AgriFood Provincia dashboards, which live in their
// own site. Without a configured address it offers a demo instead.
              ...
              <div className="grid grid-cols-12 gap-x-6 gap-y-10 md:gap-x-8">
                ...
                <div className="col-span-12 md:col-span-10">
                  ...
                  <div className="mt-10 flex flex-wrap gap-3">
                    {home ? (
                      <Button href={home} variant="solid-light" withArrow>
                        Ingresar al tablero
                      </Button>
                    ) : (
              ...
              <SectionHeading
                ...
                description={
                  DASHBOARD_URL
                    ...
                    : "El acceso a los tableros se habilita por solicitud. Escribinos y coordinamos una demo con los datos de la provincia."
                }
              />
            </Reveal>
                    ...
                    >
                      ...
                      <ul className="col-span-12 md:col-span-9">
                        {section.views.map((view) => {
                          const href = dashboardHref(view.path);
                          const body = (
                            <>
                          ...
                          return (
                            <li key={view.path}>
                              {href ? (
                                ...
                                <div className="flex items-center justify-between gap-6 px-4 py-4 opacity-60 md:-mx-4">
                                  {body}
                                </div>
                              )}
                            </li>
